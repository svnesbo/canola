...
# Clock clk_fpga_0 is defined in PS constraints
#create_clock -add -name fclk0 -period 10 [get_pins processing_system7_0_FCLK_CLK0];
...
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { sw[0] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { sw[1] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { sw[2] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { sw[3] }];
...
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { btn[0] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { btn[1] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { btn[2] }];
set_input_delay -clock [get_clocks clk_fpga_0] 5 [get_ports { btn[3] }];
...
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { JB2 }]; #IO_L15N_T2_DQS_34 Sch=JB1_N
set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { JB3 }]; #IO_L16P_T2_34 Sch=JB2_P
set_false_path -to [get_ports JB2];
set_false_path -from [get_ports JB3];

set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { JC2 }]; #IO_L10N_T1_34 Sch=JC1_N
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { JD2 }]; #IO_L5N_T0_34 Sch=JD1_N
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { JD3 }]; #IO_L6P_T0_34 Sch=JD2_P
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { JE3 }]; #IO_25_35 Sch=JE3
