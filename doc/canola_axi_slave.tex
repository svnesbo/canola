...
\begin{register}{H}{CONTROL - PULSE for 1 cycles - }{0x00000004}  \par Control register \regnewline
  \label{CONTROL}
  \regfield{unused}{22}{10}{-}
  \regfield{RESET{\_}RX{\_}STUFF{\_}ERROR{\_}COUNTER}{1}{9}{0}
  \regfield{RESET{\_}RX{\_}FORM{\_}ERROR{\_}COUNTER}{1}{8}{0}
  \regfield{RESET{\_}RX{\_}CRC{\_}ERROR{\_}COUNTER}{1}{7}{0}
  \regfield{RESET{\_}RX{\_}MSG{\_}RECV{\_}COUNTER}{1}{6}{0}
  \regfield{RESET{\_}TX{\_}RETRANSMIT{\_}COUNTER}{1}{5}{0}
  \regfield{RESET{\_}TX{\_}BIT{\_}ERROR{\_}COUNTER}{1}{4}{0}
  \regfield{RESET{\_}TX{\_}ARB{\_}LOST{\_}COUNTER}{1}{3}{0}
  \regfield{RESET{\_}TX{\_}ACK{\_}ERROR{\_}COUNTER}{1}{2}{0}
